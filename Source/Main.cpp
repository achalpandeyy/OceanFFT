...
struct OceanFFT final : public Ogle::Application
{
    ...
    void Initialize() override
    {
        ...
        // Generate the initial spectrum
        initial_spectrum_program = std::make_unique<Ogle::Shader>("C:/Projects/OceanFFT/Source/Shaders/CS_InitialSpectrum.comp");
        initial_spectrum = std::make_unique<Ogle::Texture2D>(RESOLUTION, RESOLUTION, GL_R32F, GL_RED, GL_FLOAT);

        // Generate ping/pong phase texture
        ...
        //     GL_LINEAR, GL_LINEAR);
        // normal_map->SetWrappingParams(GL_REPEAT, GL_REPEAT);
        // 
    ...
    void Update() override
    {
        ...
        if (changed)
        {
            ...
            initial_spectrum->BindImage(0, GL_WRITE_ONLY, initial_spectrum->internal_format);
        
            glDispatchCompute(RESOLUTION / COMPUTE_WORK_GROUP_DIM, RESOLUTION / COMPUTE_WORK_GROUP_DIM, 1);
            glFinish();
        ...
        // 
        // normal_map_program->SetInt("s_displacement_map_y", 0);
        ...
        read_ping_phase ? pong_phase_texture->Bind(0) : ping_phase_texture->Bind(0);

        read_ping_phase = !read_ping_phase;
        ...
        // ocean_program->SetInt("u_displacement_y", 0);
        // displacement_y->Bind(0);
        // 
        // ocean_program->SetInt("u_displacement_x", 1);
        // displacement_x->Bind(1);
        // 
        // ocean_program->SetInt("u_displacement_z", 2);
        // displacement_z->Bind(2);
        // 
        // ocean_program->SetInt("u_normal_map", 3);
        // normal_map->Bind(3);
...
private:
    ...
    std::unique_ptr<Ogle::Texture2D> initial_spectrum = nullptr;

    bool read_ping_phase = true;
    ...
    glm::vec2 wind = glm::vec2(10.f, 10.f);
